...
(let*
  (
    ...
    (default-frame
     `(
        ((background . ,ititle)  (right-edge . -4) (left-edge . -4)              (height . 40) (top-edge . -40) 
         (foreground . ("grey" "black"))  (text . ,window-name) (x-justify . center) (y-justify . center) (class . title))

        ((background . ,iclose)  (right-edge . 1)        (height . 40)           (width . 40)               (top-edge . -40)                    (class . close-button))
        ((background . ,imax)    (right-edge . 35)       (height . 40)           (width . 40)               (top-edge . -40)                    (class . maximize-button))
        ((background . ,imin)    (right-edge . 70)         (height . 40)         (width . 40)               (top-edge . -40)                    (class . iconify-button))
